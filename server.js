...
// 	root: "./views", // Set root directory that's being served. Defaults to cwd.
// 	open: false, // When false, it won't load your browser by default.
// 	ignore: '', // comma-separated string for paths to ignore
// 	file: "index.ejs", // When set, serve this file (server root relative) for every 404 (useful for single-page applications)
